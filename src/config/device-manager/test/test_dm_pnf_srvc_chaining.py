...
class TestAnsiblePNFSrvcChainingDM(TestAnsibleCommonDM):
    ...
    def test_multiple_si(self):
        ...
        srx_ri = str(srx_device_abstract_config.get("routing_instances"))
        ...
        # Verify both new_si and si are present
        qfx_ri = str(qfx_device_abstract_config.get("routing_instances"))
    ...
    def test_config(self):
        ...
        security_zones = str(srx_device_abstract_config.get("security_zones"))
        ...
        srx_physical_interfaces = str(
            srx_device_abstract_config.get("physical_interfaces"))
        ...
        # Verify bgp
        srx_bgp = str(
            srx_device_abstract_config.get("routing_instances")[0].get(
                "protocols")[0].get("bgp"))
        ...
        # Verify qfx vlans
        vlans = str(qfx_device_abstract_config.get("vlans"))
        ...
        bpg_peer_ip = (qfx_device_abstract_config.get("features")
                       .get("overlay-bgp").get("bgp")[0].get("peers")
                       [0].get("ip_address"))
        self.assertEqual(bpg_peer_ip, "2.2.2.2")

        # Verify qfx left and right interfaces
        qfx_pis = str(qfx_device_abstract_config.get("physical_interfaces"))
